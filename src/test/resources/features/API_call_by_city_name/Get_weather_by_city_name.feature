...
Scenario: Query to get some of weather API info by city name 
	Given Weather info exists by city name "Vilnius" , temperature units is "metric" , API key for the query is "2beec5873ab01758d3e7877846f47c3b"
...
Scenario: Query to check what happens if connecting without API key 
	Given Weather info exists by city name "Vilnius" , temperature units is "metric" , API key is not provided
	When Response is retrieved 
...
Scenario: Query to check what happens if city is non existing
	Given Weather info not exists by city name "Winterfell" , temperature units is "metric" , API key for the query is "2beec5873ab01758d3e7877846f47c3b"
	When Response is retrieved 
